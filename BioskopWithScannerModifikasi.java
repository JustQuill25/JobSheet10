...
public class BioskopWithScannerModifikasi {
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.println("Ahmad Franklyn Bima Aquilla");
            System.out.println("23341760027");
            System.out.println("===========================");
            ...
            switch (pil) {
                case 1:
                    while (true) {
                        ...
                        if (penonton[baris - 1][kolom - 1] != null) {
                            System.out.println(
                                    "Maaf, kursi yang anda pilih sudah terisi orang lain. Silahkan isi kembali baris dan kolom");
                            continue;
                        }
                ...
                case 2:
                    for (int i = 0; i < penonton.length; i++) {
                        ...
                        System.out
                                .println("Penonton pada baris ke-" + (i + 1) + ": " + String.join(", ", penontonBaris));
                    }
                    System.out.println();
                    break;
                case 3:
